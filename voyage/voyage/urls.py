...
urlpatterns = [
    ...
    path('admin/changepassword', auth_views.Admin_ChangePassword,
    ...
    path('mybookings/<type_of_transport>/<bookingId>/details',
         views.Booking_Details, name="booking_details"),
    path('mybookings/<type_of_transport>/<bookingId>/details/pdf',
         views.View_ticket_as_PDF, name="booking_details_as_PDF"),

    # admin views urls
    path('admin/flights', admin_views.Admin_Flights, name='admin-flights'),
    path('admin/flights/list', admin_views.Admin_Flights_List,
         name='admin-flights-list'),
    path('admin/flights/details', admin_views.Admin_Flights_Details,
         name='admin-flights-details'),
    path('admin/flights/schedule', admin_views.Admin_Flights_Schedule,
         name='admin-flights-schedule'),
    ...
    path('admin/buses/details', admin_views.Admin_Buses_Details,
         name='admin-buses-details'),
    path('admin/buses/schedule', admin_views.Admin_Buses_Schedule,
         name='admin-buses-schedule'),
